	...
	manageVideoLayer : function(_nc,opt,recalled,internrecalled) {	
		...
		switch (newvideotype) {
			...
			case "html5":
				...
				if (videowebm!=undefined && _R.get_browser().toLowerCase()=="firefox") apptxt = apptxt + '<source src="../../../../../../plugins/revolution/js/extensions/source/'+videowebm+'" type="video/webm" />';

				if (videomp!=undefined) apptxt = apptxt + '<source src="../../../../../../plugins/revolution/js/extensions/source/'+videomp+'" type="video/mp4" />';

				if (videoogv!=undefined) apptxt = apptxt + '<source src="../../../../../../plugins/revolution/js/extensions/source/'+videoogv+'" type="video/ogg" />';
		...
		if (_.videoposter!=undefined && _.videoposter.length>2 && !noposteronmobile) {
			...
			if (_nc.find('.tp-videoposter').length==0)
				...
				_nc.append('<div class="tp-videoposter noSwipe" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:3;background-image:url('../../../../../../plugins/revolution/js/extensions/source/+_.videoposter+'); background-size:cover;background-position:center center;"></div>');				
