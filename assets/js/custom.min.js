  ...
  return {
    init: function () {
      ...
      jQuery(".box-hover").on("mouseenter", function () {
        ...
        (function () {
          ...
          if (
            ...
            jQuery(".mo-left .header-nav").prepend(t),
              ...
              jQuery(".mo-left .header-nav .logo-header.dark > a > img").attr(
                "src",
                "images/e-logo.svg"
              );
          }
        ...
        jQuery(window).on("resize", function () {
          jQuery(".modal:visible").each(r), t(".equal-wraper .equal-col"), i();
        }),
    ...
    load: function () {
      e > 1023 &&
        ...
        t(".equal-wraper2 .equal-col"),
        t(".equal-wraper3 .equal-col"),
        t(".equal-wraper4 .equal-col"),
